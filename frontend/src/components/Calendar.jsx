...
const MyCalendar = () => {
  ...
  return (
    <div className='w-full mt-10 flex flex-col gap-4  h-screen'
    style={{
      backgroundImage: 'linear-gradient(to right, rgba(0,0,0,0.5), rgba(0,0,0,0.5)), url(https://images.pexels.com/photos/636243/pexels-photo-636243.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1)',
    ...
    >
      ...
      >
        <div className='flex justify-center text-white items-center  text-8xl font-bold mb-10'>
